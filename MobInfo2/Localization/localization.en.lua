-- 
-- Default English localization for MobInfo
--
...
MI_TXT_UPGRADE_REQUIRED	= "WARNING : Your MobInfo database requires an upgrade.\n\nPlease make a backup of your shared variable file now."
...
MI2_CHAT_MOBRUNS = "attempts to run away"
...
{ text = "Show Mob Information while in combat";
help = "If disabled, it will no longer show Mob information in the tooltip,\nnor will it show the MobInfo tooltip.\nThe game tooltip is shown without Mob information, while in combat.\nBy default Mob information is shown in the tooltip while in combat." }

MI2_OPTIONS["MI2_OptShowItemInfo"] = 
{ text = "Show Additional Item Information in the Item Tooltip"; 
help = "Activates the showing of item information in the item Tooltip.\nUse the Tooltip options page to choose what information to show.\nDisable this option if you do not want MobInfo to add anything\nto the item tooltip." }
...
{ text = "Rare"; help = "include Rare type mobs in search result"; }

MI2_OPTIONS["MI2_OptSearchRareElite"] = 
{ text = "Rare"; help = "include Rare Elite type mobs in search result"; }
...
{ text = "Save all party kills"; help = "Save all kills done by you or party members.";
info = "Normally when mobs are killed by party members, but the player\nor player's pet did not do any damage it is not recorded as a kill." }
...
{ text = "Compress database when logging out."; help = "When the database gets too big to store as a plain table, it is better to store it compressed.";
info = "When using this option please note that there will be a load time and save penalty.\n\nWhen running into \"constant table overflow\" error, restore backup and enable this."; }
...
MI2_TXT_Summary = "MobInfo Summary"
MI2_TXT_Price= { text="Price",tooltipText="Total price using auction information if available" }
MI2_TXT_AverageValue= { text="Avg Value",tooltipText="Average value per unit (using auction pricing if available)" }
MI2_TXT_LootName = { text="Name", tooltipText="Loot name" }
MI2_TXT_SourceName = { text="Name", tooltipText="Source name" }
MI2_TXT_SourceType = { text="Type", tooltipText="Type of source (Creature/Vehicle/GameObject)" }
MI2_TXT_Vendor = { text="Vendor",tooltipText="Total vendor price" }
MI2_TXT_AverageVendor= { text="Avg Vendor",tooltipText="Average vendor value per unit" }
MI2_TXT_Quantity = { text="#",tooltipText="Number of Loots" }
MI2_TXT_NumMobs = { text="#M",tooltipText="Number of Mobs" }
MI2_TXT_NumNonMobs = { text="#NM",tooltipText="Number of Non Mobs" }
MI2_TXT_Time = { text="Time",tooltipText="Time since last looted" }
MI2_TXT_ID = { text="ID",tooltipText="The internal id" }
MI2_TXT_FilterMoney = "Money"

MI2_TXT_NumItems = { text="#L",tooltipText="Number of loots" }
MI2_TXT_NumSources = { text="#",tooltipText="Number of sources" }
MI2_TXT_NumUniqueItems = { text="#UL",tooltipText="Number of unique loots" }

MI2_TXT_SummaryReset = { text = "Reset", tooltipText="Reset MobInfo loot dialog"; }
MI2_TXT_SummaryFont = {
  [1] = { font = GameFontWhiteTiny2, text = "Super Tiny", tooltipText="Use Super Tiny font for results lists" },
  [2] = { font = GameFontWhiteTiny, text = "Tiny", tooltipText="Use Tiny font for results lists" },
  [3] = { font = GameFontNormalSmall, text = "Small", tooltipText="Use Small font for results lists" },
  [4] = { font = GameFontNormal, text = "Normal", tooltipText="Use Normal font for results lists" },
  [5] = { font= GameFontNormalLarge, text = "Large", tooltipText="Use Large font for results lists" }
}

MI2_TXT_ToggleOptions = "|cffffff00Click|r to open MobInfo Options"
MI2_TXT_ToggleSummary = "|cffffff00Right-click|r to toggle MobInfo Summary"
