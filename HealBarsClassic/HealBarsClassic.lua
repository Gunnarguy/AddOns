-- local libCHC = LibStub("LibHealComm-2.0-Classic", true)
...
HBCDefaultColors = { ['flat'] = { 130 / 255, 1, 0, 1.0 }, ['hot'] = { 110 / 255, 230 / 255, 55 / 255, 0.7 }, ['ownFlat'] = { 255 / 255, 0 / 255, 135 / 255, 1 }, ['ownHot'] = { 230 / 255, 76 / 255, 105 / 255, 0.7 } }
...
function HealBarsClassic:createHealBars(unitFrame, textureType)
  ...
  local shieldFrame = healthBar:CreateTexture("HBCShieldBar" ..
    unitFrame:GetName(), 'ARTWORK', nil, 2)
  ...
  local eventFrame = CreateFrame("Frame", "HealBarsClassicEventFrame" ..
    unitFrame:GetName(), unitFrame)
  eventFrame:SetScript("OnEvent", function (self)
    HealBarsClassic:UpdateHealBars(self:GetParent())
  end)
  local shieldEventFrame = CreateFrame("Frame", "HealBarsClassicAuraEventFrame" ..
    unitFrame:GetName(), unitFrame)
