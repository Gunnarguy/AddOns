...
L.RAID_DOWN_NR						= "%s пройден за %s! Это новый рекорд! (Предыдущий рекорд был %s)."
...
L.AUTO_SPEC_WARN_TEXTS.adds				= "Прибыли адды - переключитесь"
L.AUTO_SPEC_WARN_TEXTS.addscount		= "Прибыли адды - переключитесь (%%s)"
