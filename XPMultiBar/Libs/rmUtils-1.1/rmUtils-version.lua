...
if WOW_PROJECT_ID and WOW_PROJECT_CLASSIC and WOW_PROJECT_BURNING_CRUSADE_CLASSIC and WOW_PROJECT_WRATH_CLASSIC
		and WOW_PROJECT_CATACLYSM_CLASSIC and WOW_PROJECT_MISTS_CLASSIC then
	...
	U.IsMistsClassic = WOW_PROJECT_ID == WOW_PROJECT_MISTS_CLASSIC
else
