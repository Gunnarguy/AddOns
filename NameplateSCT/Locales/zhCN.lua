...
L["Disabled"] = "停用"
L["Display Icon"] = "显示图标"
L["Display Icon Only"] = "仅显示图标"
L["Display only the icon for damage.\nWill not change Miss, Dodge, Parry, etc displays"] = "仅显示伤害图标。\n不会更改未命中、招架、躲闪等显示"
...
L["Personal SCT Only"] = "仅个人浮动战斗文字"
L["Personal SCT"] = "个人浮动战斗文字"
L["Position"] = "位置"
L["Rainfall"] = "雨落"
L["Randomly varies the starting horizontal position of each damage number."] = "随机每个伤害数字的起始横向位置。"
L["Randomly varies the starting vertical position of each damage number."] = "随机每个伤害数字的起始纵向位置。"
L["Reflected"] = "反射"
L["Resisted"] = "抵抗"
L["Right"] = "右侧"
