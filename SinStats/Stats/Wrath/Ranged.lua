...
function Ns.RangedUpdate()
	...
	Ns.critRanged = Ns.critRanged + Ns.totemWrath + Ns.heartCrusader
...
function Ns.FunctionList.RDMG(HUD, data, options, ...)
	...
	local maxDamage = (Ns.hiDmg + Ns.hemoDmg + (Ns.hiDmg * Ns.bloodFrenzy) + (Ns.hiDmg * Ns.savageCombat) + (Ns.hiDmg * Ns.BeastSlaying) + (Ns.hiDmg * Ns.FocusedFire) +
					  (Ns.hiDmg * Ns.trickTrade) + (Ns.hiDmg * Ns.hysteria))
	local avgDamage = (Ns.hiDmg + Ns.lowDmg + Ns.hemoDmg + (Ns.hiDmg * Ns.bloodFrenzy) + (Ns.hiDmg * Ns.savageCombat) + (Ns.hiDmg * Ns.BeastSlaying) +
					  (Ns.hiDmg * Ns.FocusedFire) + (Ns.hiDmg * Ns.trickTrade) + (Ns.hiDmg * Ns.hysteria)) / 2
	local returnText
...
function Ns.FunctionList.rDPS(HUD, data, options, ...)
	...
	local lowDamage = (Ns.lowDmg + Ns.hemoDmg + (Ns.lowDmg * Ns.bloodFrenzy) + (Ns.lowDmg * Ns.savageCombat) + (Ns.lowDmg * Ns.BeastSlaying) + (Ns.lowDmg * Ns.FocusedFire) +
...
function Ns.FunctionList.RangedMiss(HUD, data, options, ...)
	...
	if Ns.Band(EB, SameLevel) then returnText = (decimals):format(rangedMissLevel) .. liveMiss end
	if Ns.Band(EB, BossLevel) then returnText = (decimals):format(rangedMissBoss) .. liveMiss end
	if Ns.Band(EB, Both) then returnText = (decimals):format(rangedMissLevel) .. " (" .. (decimals):format(rangedMissBoss) .. ")" .. liveMiss end
